...
urlpatterns = [
    ...
    path('owner/credit-analytics/summary/', views.owner_credit_analytics_summary),
    path('owner/credit-analytics/by-restaurant/', views.owner_credit_analytics_by_restaurant),
    path('owner/credit-analytics/customer-report/', views.owner_credit_analytics_customer_report),
    path('owner/credit-analytics/vendor-report/', views.owner_credit_analytics_vendor_report),
    path('owner/credit-analytics/staff-report/', views.owner_credit_analytics_staff_report),
    path('owner/credit-analytics/trend/', views.owner_credit_analytics_trend),
    path('owner/credit-analytics/aging/', views.owner_credit_analytics_aging),
    path('owner/credit-analytics/risk/', views.owner_credit_analytics_risk),
